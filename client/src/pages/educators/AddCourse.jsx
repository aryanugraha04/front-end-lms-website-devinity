      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        ...
        <div className='flex items-center justify-between flex-wrap'>
          <div className='flex flex-col gap-1'>
            ...
            {coursePrice} type="number" placeholder='o' className='outline-none 
          ...
          <div className='flex md:flex-row flex-col items-center gap-3'>
            ...
            <label htmlFor="thumbnailImage" className='flex items-center gap-3'>
              <img src={assets.file_upload_icon} alt="" className='p-3 bg-orange-500 
              rounded' />
        ...
        <div>
                ...
                <div className='p-4'>
                  {chapter.chapterContent.map((lecture, lectureIndex)=>(
                    ...
                    items-center mb-2'>
                      ...
                      target='_blank' className='text-orange-500'>Link</a> - {lecture.
          ...
          <div className='flex justify-center items-center bg-orange-100 p-2 
          ...
          {showPopup && (
            ...
            bg-gray-800/50'>
              ...
              max-w-80'>
                ...
                <button type='button' className='w-full bg-orange-400 text-white px-4 
