...
const CourseDetail = () => {
  ...
  return courseData ? (
    ...
    justify-between md:px-36 px-8 md:pt-30 pt-20 text-left bg-gradient-to-b from-orange-100/70 to-white'>
      
      <div className='absolute top-0 left-0 w-full h-[500px]'></div>

      {/* left column */}
      <div className='max-w-xl z-10 text-gray-500'>
        <h1 className='md:text-[36px] leading[44px] text-[26px] leading[36px] 
      ...
      <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
          ...
          <p className='text-orange-600'>({courseData.courseRatings.length} {courseData.
          courseRatings.length > 1 ? 'ratings' : 'rating'})</p>

          <p>{courseData.enrolledStudents.length} {courseData.enrolledStudents.length > 1 ? 'students' : 'student'}</p>
        </div>

        <p className='text-sm'>Course by <span className='text-orange-600 
        underline'>Devinity</span></p>
      ...
      {/* right column */}
      <div className='max-w-[424px] z-10 shadow-[0px_4px_15px_2px_rgba(0,0,0,0.1)] rounded-t 
      md:rounded-none bg-white min-w-[300px] sm:min-w-[420px]'>
        ...
        <div className='p-5'>
          ...
          <button className='md:mt-6 mt-4 w-full py-3 rounded bg-orange-600 
