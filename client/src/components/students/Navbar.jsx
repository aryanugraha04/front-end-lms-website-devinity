...
const Navbar = () => {
  ...
  return (
    ...
    lg:px-36 border-b border-gray-500 py-4 ${isCourseListPage ? 'bg-white' : 'bg-orange-100/70'}`}>
      ...
      <div className='hidden md:flex items-center gap-5 text-gray-500'>
        ...
        { user ? <UserButton/> : 
          <button onClick={() => openSignIn()} className='bg-orange-500 text-white px-5 py-2 
